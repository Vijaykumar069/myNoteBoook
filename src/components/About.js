                ...
                <div className="content">
                    <div className="top">
                        ...
                        <div className="media-icons">
                            ...
                            <a href="https://www.instagram.com/stupid_bouy069" target="_blank" rel="noopener noreferrer"><i className="fab fa-instagram"></i></a>
                            {/* <Link to="/https://www.instagram.com/stupid_bouy069"><i className="fab fa-instagram"></i></Link> */}
